/*******************************************************************************
<!--
ADL SCORM 2004 4th Edition DMCE

 

The ADL SCORM 2004 4th Ed. DMCE is licensed under
...
function getAPI()
{
   ...
   if (theAPI == null)
   {
     ...
     //        "Communication with the LMS will not occur." );
      ...
      noAPIFound = "true";
	  //if (jQuery.lacerta.scorm)
		//jQuery.lacerta.scorm.noAPIFound = true;
   }
...
function displayErrorInfo( errCode )
{
	...
	if (jQuery.lacerta.scorm)
		jQuery.lacerta.scorm.transmitErroData(errCode, errString, errDiagnostic);
}
